              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-zinc-800">
                    ...
                    <th className="text-left py-3 px-4 text-sm font-semibold text-zinc-300">Platform</th>
                ...
                <tbody>
                  {users.map((user) => (
                    ...
                    >
                      ...
                      <td className="py-3 px-4 text-sm text-zinc-300 capitalize">{user.platform || "-"}</td>
                      <td className="py-3 px-4 text-sm text-zinc-300">
